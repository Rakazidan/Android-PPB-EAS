        ...
        call.enqueue(new Callback<News>() {
            ...
            public void onResponse(Call<News> call, Response<News> response) {
                if (response.isSuccessful() && response.body().getArticle() != null) {
                    ...
                    adapter = new Adapter(articles, com.example.berita.activity.SearchActivity.this);
                    ...
                    Toast.makeText(com.example.berita.activity.SearchActivity.this, "No Result", Toast.LENGTH_SHORT).show();
                }
            }
