...
public class TechnologyActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        layoutManager = new LinearLayoutManager(com.example.berita.activity.TechnologyActivity.this);
    ...
    public void LoadJson() {
        ...
        Call<News> call;
        call = apiInterface.getTechnology("id","technology", API_KEY);
        ...
        call.enqueue(new Callback<News>() {
            ...
            public void onResponse(Call<News> call, Response<News> response) {
                if (response.isSuccessful() && response.body().getArticle() != null) {
                    ...
                    adapter = new Adapter(articles, com.example.berita.activity.TechnologyActivity.this);
                    ...
                    Toast.makeText(com.example.berita.activity.TechnologyActivity.this, "No Result", Toast.LENGTH_SHORT).show();
                }
            }
    ...
    private void initListener() {
        ...
        adapter.setOnItemClickListener(new Adapter.OnItemClickListener() {
            ...
            public void onItemClick(View view, int position) {
                Intent intent = new Intent(TechnologyActivity.this, NewsDetailActivity.class);
