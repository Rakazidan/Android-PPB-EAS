...
public class SportsNewsActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        layoutManager = new LinearLayoutManager(com.example.berita.activity.SportsNewsActivity.this);
    ...
    public void LoadJson() {
        ...
        Call<News> call;
        call = apiInterface.getSports("id","sports", API_KEY);
        ...
        call.enqueue(new Callback<News>() {
            ...
            public void onResponse(Call<News> call, Response<News> response) {
                if (response.isSuccessful() && response.body().getArticle() != null) {
                    ...
                    adapter = new Adapter(articles, com.example.berita.activity.SportsNewsActivity.this);
                    ...
                    Toast.makeText(com.example.berita.activity.SportsNewsActivity.this, "No Result", Toast.LENGTH_SHORT).show();
                }
            }
