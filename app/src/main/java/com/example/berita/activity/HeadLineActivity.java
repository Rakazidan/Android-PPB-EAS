...
public class HeadLineActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        layoutManager = new LinearLayoutManager(HeadLineActivity.this);
        ...
        call.enqueue(new Callback<News>() {
            ...
            public void onResponse(Call<News> call, Response<News> response) {
                if (response.isSuccessful() && response.body().getArticle() != null) {
                    ...
                    adapter = new Adapter(articles, com.example.berita.activity.HeadLineActivity.this);
                    ...
                    Toast.makeText(com.example.berita.activity.HeadLineActivity.this, "No Result", Toast.LENGTH_SHORT).show();
                }
            }
    ...
    private void initListener() {
        ...
        adapter.setOnItemClickListener(new Adapter.OnItemClickListener() {
            ...
            public void onItemClick(View view, int position) {
                Intent intent = new Intent(HeadLineActivity.this, NewsDetailActivity.class);
