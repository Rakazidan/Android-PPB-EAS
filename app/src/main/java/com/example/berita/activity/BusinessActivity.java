...
public class BusinessActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        layoutManager = new LinearLayoutManager(com.example.berita.activity.BusinessActivity.this);
    ...
    public void LoadJson() {
        ...
        Call<News> call;
        call = apiInterface.getBusiness("id","business", API_KEY);
        ...
        call.enqueue(new Callback<News>() {
            ...
            public void onResponse(Call<News> call, Response<News> response) {
                if (response.isSuccessful() && response.body().getArticle() != null) {
                    ...
                    adapter = new Adapter(articles, com.example.berita.activity.BusinessActivity.this);
                    ...
                    Toast.makeText(com.example.berita.activity.BusinessActivity.this, "No Result", Toast.LENGTH_SHORT).show();
                }
            }
